...
- If you need help connecting to your virtual machine, please see my tutorial [here](https://github.com/bernardtabiri/virtualmachine)
...
Click [here](https://github.com/sirueys/post-install-config) to move on to part 2 of this tutorial!
